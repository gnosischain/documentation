...
* [ETH-GC AMB](/bridges/eth-gc), requests from Gnosis Chain to the Ethereum Mainnet
...
* [BSC-GC AMB](/bridges/bsc-gc), requests from Gnosis Chain to Binance Smart Chain
