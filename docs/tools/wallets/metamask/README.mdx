...
<Tabs>
  <TabItem value="chainlist" label="Chain List">Use <a href="https://chainlist.org/?search=gnosis">ChainList</a> for a one-click configuration and follow the instructions.
  </TabItem>
  <TabItem value="deeplink" label="Deeplink">Click on <a href="https://shanejonas.github.io/metamask-link/deep?method=wallet_addEthereumChain&params[0][chainId]=0x64&params[0][chainName]=Gnosis&params[0][rpcUrls][0]=https://rpc.gnosischain.com&params[0][nativeCurrency][name]=xDAI&params[0][nativeCurrency][symbol]=xDAI&params[0][nativeCurrency][decimals]=18&params[0][blockExplorerUrls][0]=https://blockscout.com/xdai/mainnet">this deeplink</a> to auto-configure MetaMask and follow the instructions.</TabItem>
</Tabs>
...
- [Add Metamask programmatically in your dApp](/developers/gnosis-interaction/metamask)
