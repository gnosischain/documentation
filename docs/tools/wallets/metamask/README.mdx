...
<Tabs>
  ...
  <TabItem value="deeplink-chiado" label="Deeplink (Chiado Testnet)">Click on <a href="https://shanejonas.github.io/metamask-link/deep?method=wallet_addEthereumChain&params[0][chainId]=0x18704&params[0][chainName]=Chiado&params[0][rpcUrls][0]=https://rpc-chiado.gnosistestnet.com&params[0][nativeCurrency][name]=Chiado xDAI&params[0][nativeCurrency][symbol]=xDAI&params[0][nativeCurrency][decimals]=18&params[0][blockExplorerUrls][0]=https://blockscout-chiado.gnosistestnet.com">this deeplink</a> to auto-configure Chiado Testnet in MetaMask and follow the instructions.</TabItem>
</Tabs>
