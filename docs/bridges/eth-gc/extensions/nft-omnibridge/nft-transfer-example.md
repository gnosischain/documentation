...
:::info
If you want to bridge an [ERC1155 NFT or NFT collection, instructions are here](/bridges/eth-gc/extensions/nft-omnibridge/eip1155-based-nft-transfer-example).
:::
...
![](/img/bridges/nftbridge1.png)

![](/img/bridges/nft2.png)
...
![Copy and paste the hash into https://alm-xdai.herokuapp.com/](/img/bridges/mm2.png)
...
![Click to view more info](/img/bridges/alm-1.png)

In BlockScout, click on the TokenID to see information more information on the token.

![Token Minting Transaction](</img/bridges/bs-1-1.png>)

![Click the Metadata tab for details on the ERC721 in your account.](</img/bridges/bs-2-metadata.png>)
