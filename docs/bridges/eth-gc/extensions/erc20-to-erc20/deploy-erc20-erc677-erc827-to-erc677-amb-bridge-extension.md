...
1. Verify that tokens can be transferred in both directions through the bridge. See the [the sUSD bridge AMB extension](/bridges/eth-gc/extensions/susd/) for an example process.
