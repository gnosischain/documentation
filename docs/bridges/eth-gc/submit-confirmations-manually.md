...
![In this example we use BlockScout on the GC side.](</img/bridges/image-102.png>)
...
![Using Etherscan to Write to the AMB contract on Ethereum ](</img/bridges/image-95.png>)
