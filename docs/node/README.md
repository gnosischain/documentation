...
- Gnosis aims to be a learning ground for a new generation of node runners, requiring only 1 GNO (around $140 at March 2025) instead of the 32 ETH (around $70.000 at March 2025) minimum required for Ethereum
