...
The Beacon Node requires an Execution client in order to operate. See [Step 2: Run Execution Client](../execution/_partials/_run-execution-client.md) for more information.
