...
:::caution
**Optional:**  [Setup and run a Gnosis Chain Node](/node/client/nethermind): This step is for experienced node runners only. To begin, it is not needed but will be encouraged for the merge. Instructions below include a default option to connect to the public RPC.
:::
